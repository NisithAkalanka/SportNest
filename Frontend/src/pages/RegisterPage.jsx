...
const EyeClosedIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414ல-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.074l-1.78-1.781zm4.261 4.26l1.514 1.515a2 2 0 01-2.828 2.828l-1.515-1.514A4 4 0 0010 14a4 4 0 10-2.032-7.44z" clipRule="evenodd" />
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 2) Single API call to register member
        ...
        <div className="w-full lg:w-1/2 bg-white p-8 md:p-12">
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              ...
              className="submit-btn bg-orange-500 hover:bg-orange-600 w-full mt-8 font-bold py-3 px-4 rounded-lg text-white"
            >
