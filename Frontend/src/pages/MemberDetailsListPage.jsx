...
// Reusable Sub-Statistic Component
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-2">
            <DetailRow
              ...
              to="/admin-dashboard/user-management/all"
            />
            <DetailRow
              icon={<FaUserCheck />}
              label="Active Memberships"
              value={summary.membersWithPlan}
              to="/admin-dashboard/user-management/status/active"
            />
            <DetailRow
              icon={<FaUserTimes />}
              label="No Membership Plan"
              value={summary.membersWithoutPlan}
              to="/admin-dashboard/user-management/status/inactive"
            />
            <hr className="my-2" />
            <DetailRow
              icon={<FaChild />}
              ...
              to="/admin-dashboard/user-management/plan/Student Membership"
            />
            <DetailRow
              icon={<FaIdCard />}
              label="Ordinary Plans"
              value={summary.planCounts.ordinary || 0}
              to="/admin-dashboard/user-management/plan/Ordinary Membership"
            />
            <DetailRow
              icon={<FaIdCard />}
              label="Life Time Plans"
              value={summary.planCounts.lifeTime || 0}
              to="/admin-dashboard/user-management/plan/Life Time Membership"
            />
          </div>
        </div>
